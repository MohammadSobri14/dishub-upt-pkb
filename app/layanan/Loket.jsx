...
const Loket = () => {
  return (
    <section className="relative min-h-screen bg-white py-16 px-4 md:px-20 overflow-hidden">
      ...
      {/* Gambar jalan */}
      <div className="absolute top-0 left-[680px] transform -translate-x-1/2 h-full z-0 pointer-events-none">
        <Image
        ...
        {steps.map((step, index) => {
          ...
          return (
            <motion.div
              ...
              className={`absolute ${step.style}`}
            >
              <div
                className="w-full max-w-[350px] bg-white rounded-2xl shadow-lg px-6 py-6 flex flex-col md:flex-row items-center gap-6
